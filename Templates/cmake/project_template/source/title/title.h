...
class Title {
    ...
    private:
        ...
        const struct {
            ...
            Vector2 cursor = {536.0f, 464.0f};      // Cursor
        } position;
        ...
        struct {
            ...
            const uint8_t total_options = 3;        // Numero de opciones
            const int32_t first_option = 0;         // Definicion del numero de opciones
            const int32_t last_option = 2;
            const float cursor_offset = 64.0f;      // Distancia entre opciones
        } menu;
