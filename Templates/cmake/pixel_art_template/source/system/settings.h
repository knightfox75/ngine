/******************************************************************************
    ...
    Pixel Art Project Template: Configuracion
...
/*** Parametros de la ventana ***/
    ...
    const std::string WINDOW_TITLE = "N'gine Pixel Art Game Template [Debug]";          // Titulo de la ventana
#else
    const std::string WINDOW_TITLE = "N'gine Pixel Art Game Template ";                 // Titulo de la ventana
#endif
const uint32_t SCR_WIDTH = 640;                                                         // Resolucion
const uint32_t SCR_HEIGHT = 360;
