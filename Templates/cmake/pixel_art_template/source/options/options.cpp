/******************************************************************************
    ...
    Pixel Art Project Template: Menu de opciones
...
void Options::MenuCreateOptions() {
    ...
    sprite[idx] = new NGN_Sprite(RS_LOCAL, "x1", pos.x, pos.y);
    pos.x += item_position.full_screen.offset;
    idx ++;
    sprite[idx] = new NGN_Sprite(RS_LOCAL, "x2", pos.x, pos.y);
    pos.x += item_position.full_screen.offset;
    idx ++;
    sprite[idx] = new NGN_Sprite(RS_LOCAL, "full", pos.x, pos.y);
...
void Options::MenuSetOption() {
    ...
    switch (cursor.option) {
        ...
        case menu_option.full_screen:
            game_options.screen_mode = MenuSelectValue(game_options.screen_mode, 2);
            break;
...
void Options::MenuUpdate() {
    ...
    // Opcion "FULL SCREEN"
    MenuSwitch(sprite_id.full_screen, game_options.screen_mode, 3);
    // Opcion "FILTERING"
...
void Options::MenuApplyOptions(bool sfx_enabled) {
    ...
    if (game_options.screen_mode != last_game_options.screen_mode) {
        switch (game_options.screen_mode) {
            case 0:
