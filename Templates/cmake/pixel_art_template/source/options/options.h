    ...
    private:
        ...
        struct {
            enum {
                ...
                filtering = (full_screen + 3),              // Opcion "Filtrado"
        ...
        const struct {
            ItemPosition main_volume = {80, 128, 16};
            ItemPosition music = {80, 192, 16};
            ItemPosition effects = {80, 256, 16};
            ItemPosition full_screen = {440, 128, 64};
            ItemPosition filtering = {432, 192, 48};
            ItemPosition vsync = {432, 256, 48};
        } item_position;
