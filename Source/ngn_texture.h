   ...
   // Public
    public:
        ...
        NGN_Texture(
                    ...
                    int32_t texture_width = NGN_DEFAULT_VALUE,      // Ancho de la textura (por defecto, el de la textura)
                    int32_t texture_height = NGN_DEFAULT_VALUE      // Altura de la textura (por defecto, la de la textura)
                    );
